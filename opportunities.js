...
function renderRow(v = {}, prepend = false) {
    ...
    mainRow.innerHTML = `
        ...
        <td>
            <input type="text" class="excel-input exp-date-input readonly-input" value="${v.expDate || ''}" data-old="${v.expDate || ''}" readonly style="cursor:pointer;" onclick="openCustomDatePicker(this, '${rowId}')" placeholder="اختر التاريخ">
...
/* ==========================================================
   9. منطق الـ Date Picker المخصص (Custom Date Picker)
   ========================================================== */
...
function initDatePicker() {
    ...
    document.querySelector(".dp-picker").addEventListener("click", (e) => {
...
function openCustomDatePicker(inputEl, rowId) {
